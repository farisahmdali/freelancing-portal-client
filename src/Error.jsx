      ...
      <div className="flex flex-col items-stretch mt-5">
        ...
        <div className="flex flex-row group px-4 py-8
          ...
          <div className="grow flex flex-col pl-5 pt-2">
            <div onClick={()=>navigate("/",{replace:true})} className="font-bold text-sm md:text-lg lg:text-xl group-hover:underline">
              Home Page
            </div>
        ...
        <div className="flex flex-row group px-4 py-8
          ...
          {/* Text */}
          <div className="grow flex flex-col pl-5 pt-2">
            <div onClick={()=>navigate("/login",{replace:true})} className="font-bold text-sm md:text-lg lg:text-xl group-hover:underline">
              Log in
            </div>
            <div className="font-semibold text-sm md:text-md lg:text-lg
                      text-gray-400 group-hover:text-gray-500
                      transition-all duration-200 delay-100">
              Let's Login an d explore
            </div>
          </div>
          {/* Chevron */}
          <i className="mdi mdi-chevron-right text-gray-400 mdi-24px my-auto pr-2
