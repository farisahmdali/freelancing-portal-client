  ...
  return (
    <div className="home" id="home">
      ...
      <div className="content">
        <h1 className="mb-4 mt-20 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          A spot for creative to get a job
        </h1>
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
          Unleash your skills, seize opportunities, shape your destiny. Join our
          team, where limitless possibilities await talented professionals like
          you.
        </p>
        <button
          className="btn-primary size-20 m-5 p-5  "
      ...
      <div className="row grid md:grid-cols-2 p-5">
        <div className="about mt-5 col-md-6">
          ...
          <p className="text-white  size-20 ">
            At GetDone, we believe in the power of talent and collaboration. Our
            mission is to empower freelancers and businesses by providing a
            seamless platform to connect, communicate, and succeed together.
          ...
          <ul className=" space-y-1 text-white list-disc list-inside ">
            ...
            <li>
              Collaborate: Communicate with clients, ask questions, and discuss
              project details.
            </li>
            <li>
