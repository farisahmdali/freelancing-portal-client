...
function NavBar2() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 transition-05s w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button
          ...
          type="button"
          class="inline-flex items-center p-2 btn-down w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div
          class="hidden slide-down transform w-full md:block md:w-auto" id="navbar-default"
        >
